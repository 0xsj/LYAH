...
val gh = GitHubSettings(org = "com.YourOrgName", proj = "sbt-catalyst", publishOrg = "com.YourOrgName", license = apache2)
...
lazy val Sbtcatalyst = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "sbt-catalyst"),
    micrositeDocumentationUrl := "/sbt-catalyst/api/com.YourOrgName/index.html",
